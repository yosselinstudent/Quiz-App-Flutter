          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (_,index){
                  return Card(
                    color: quiz.questions[index].correct ? Colors.green.shade200: Colors.red.shade200,
                    child: ListTile(
                      leading: quiz.questions[index].correct ? Icon(Icons.check, color: Colors.green.shade900,): Icon(Icons.close, color: Colors.red.shade900,),
